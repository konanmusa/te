...
# if x.strftime('%x') > g.strftime('%x'):
    # print('\n\n')
    # print('     تم توقيف اداة راسل المطور لتفعيله المدفوع @@V_VZ_VZ')
    # print('\n\n')
    # print(x)
    # sys.exit(0)
# if x.strftime('%x') == g.strftime('%x'):
    ...
    # if x.strftime('%X') > g.strftime('%X'):
        # print('\n\n')
        # print('     انتهى وقت تفعيل الاداة للاشتراك المدفوع راسل المطور @V_VZ_VZ')
        # print('\n\n')
        # print(x)
        # sys.exit(0)
    # else:
...
print(('—'*25)+'\n• DeCoDe By @V_VZ_VZ •\n'+('—'*25))
output = render('M I K E Y', colors=['red', 'green'], align='center')
print(output)
print(('—'*25)+'\n• DeCoDe By @V_VZ_VZ •\n'+('—'*25))
print('\n')
...
print(('—'*25)+'\n• DeCoDe By @V_VZ_VZ •\n'+('—'*25))
tlg1 = '\n𝚆𝙴𝙻𝙲𝙾𝙼𝙴 -مرحب بك في اداة المطور مايكي\n𓅃━━━━━━━━❖━━━━━━━━━𓅃\n𝙿𝙻𝙴𝙰𝚂𝙴 𝚆𝙰𝙸𝚃  ➩ \nتم تشغيل الاداة المدفوعه\n    \nلا تـنسى ان تـرسل صـور الـصيد -  @V_VZ_VZ\n\n𓅃━━━━━━━━❖━━━━━━━━━𓅃 '
...
#		method.append('touch')
	...
	_jembot_ = input('\033[1;33m➙ Choose :')
	if _jembot_ in ['']:
...
def crack(idf,pwv):
	...
	fff = '%'
	print('\r%s{\033[1;33m [𝕄𝕀𝐊𝔼𝕐] %s/%s ➙ \033[1;95m[ [𝐓𝐑𝐔𝐄]] %s ➙\033[1;31m [ [𝐁𝐋𝐎𝐂𝐊]] %s .. } %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
...
BY = @V_VZ_VZ'''
					...
					infoakun += f'''مايكي جابلك حساب صحيح
⋘─────━𓆩𝕄𝕀𝐊𝔼𝕐𓆪‏━─────⋙
